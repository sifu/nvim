...
return {"nvim-telescope/telescope.nvim", dependencies = {"nvim-telescope/telescope-ui-select.nvim", "nvim-lua/popup.nvim", "nvim-lua/plenary.nvim", "albenisolmos/telescope-oil.nvim", "JoseConseco/telescope_sessions_picker.nvim"}, config = _1_}
