...
local function _1_()
  ...
  return lsp.fennel_language_server.setup({on_attach = on_attach, handlers = handlers, before_init = before_init, capabilities = capabilities, settings = {fennel = {diagnostics = {globals = {"vim"}}}}})
end
