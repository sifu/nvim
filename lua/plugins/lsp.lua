...
local function _2_()
  ...
  return mason_lspconfig.setup({ensure_installed = {"fennel_language_server", "ts_ls", "cssmodules_ls", "cssls", "clojure_lsp"}}, lspconfig.fennel_language_server.setup(fennel_opts), lspconfig.ts_ls.setup({}), lspconfig.cssmodules_ls.setup({}), lspconfig.cssls.setup({}), lspconfig.clojure_lsp.setup({}))
end
