...
return {"MeanderingProgrammer/render-markdown.nvim", ft = {"markdown"}, cmd = {"RenderMarkdown"}, dependencies = {"nvim-treesitter/nvim-treesitter", "nvim-tree/nvim-web-devicons"}, opts = {render_modes = {"n", "c", "t"}, anti_conceal = {enabled = false}, indent = {enabled = true, skip_level = 1, skip_heading = true, icon = ""}, checkbox = {custom = {todo = {raw = "[-]", rendered = "\243\177\139\173 ", highlight = "RenderMarkdownCanceled"}}, bullet = true}, heading = {icons = {"\239\157\170 ", "\239\157\171 ", "\239\157\172 ", "\239\157\173 ", "\239\157\174 "}, signs = {"\239\135\156", "\239\135\156", "\239\135\156", "\239\135\156", "\239\135\156"}, position = "inline", backgrounds = {}}, completions = {lsp = {enabled = true}}}, config = _3_}
