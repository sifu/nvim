...
local groups = {{"<leader>g", "Git"}, {"<leader>c", "Conjure"}, {"<leader>l", "LSP"}, {"<leader>a", "Avante/ChatGPT"}, {"<leader>ac", "ChatGPT"}, {"<leader>t", "Tabs"}, {"<space>", "Search"}, {"ga", "Change Text Case"}}
